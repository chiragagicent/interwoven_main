 ...
 <form id="eventEditForm" method="POST" action="{{ route('events.update', $event->event_id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="mb-3">
                <label for="media_url" class="form-label">Upload Image</label>
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3" id="offlineFields" style="{{ !$event->mode ? 'display: block;' : 'display: none;' }}">
                ...
                <input type="text" class="form-control" id="offline_address" name="offline_address" value="{{ $event->offline_address }}" >
